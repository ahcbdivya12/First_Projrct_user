...
<html lang="en">
  <head>
    ...
    <!-- Main Style Sheet -->
    <link rel="stylesheet" href="..\jounrul\sad.css" />
    <!-- Font Awesome -->
    <link
      rel="stylesheet"
  ...
  <body> 
    <script type="text/javascript">
      function con() {
        confirm("Thanku for sharing Your felling with Us.");
      }
    </script>
   <header><h1 class="title">My Personal Journal</h1></header>
      ...
      <div class="container">
        <div class="container-row container-row-journal">
          <div class="container-item container-item-journal">
           <form  method = "post"action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">      <label for="entry-title" class="journal-label">Entry Title</label>
              <input
                type="text"
                name="title"
              ...
              <input type="submit" class="btn-main entry-submit-btn"  name="signup1" value="submit"onclick="con()">         </form>
          </div>
        </div>
      </div>
    </section>
    ...
    <script src="..\jounrul\angry.js"></script>
  </body>
</html>
