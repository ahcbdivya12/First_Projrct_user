...
<html lang="en">
  <head>
    ...
    <!-- Main Style Sheet -->
    <link rel="stylesheet" href="..\jounrul\happy.css" />
    <!-- Font Awesome -->
    <link
      rel="stylesheet"
  ...
  <body>
        ...
        <div class="container-row container-row-journal">
          <div class="container-item container-item-journal">
            <form  method = "post"action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">     <label for="entry-title" class="journal-label">Entry Title</label>
              ...
              ></textarea>
              <input type="submit" class="btn-main entry-submit-btn"  name="signup1" value="submit"onclick="con()">
            </form>
          </div>
        </div>
      </div>
    ...
    <script src="..\jounrul\happy.js"></script>
  </body>
</html>
